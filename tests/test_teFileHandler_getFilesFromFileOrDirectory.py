...
def test_getFilesFromFileOrDirectory_dir_parent():
  assert teFileHandler.getFilesFromFileOrDirectory(dir_parent) == []

def test_getFilesFromFileOrDirectory_dir_parent_recurs():
  assert teFileHandler.getFilesFromFileOrDirectory(dir_parent,True) == ['test_data\\csv_files\\csv1.csv', 'test_data\\log_files\\log1.log', 'test_data\\mixed_files\\csv1.csv', 'test_data\\mixed_files\\log1.log', 'test_data\\mixed_files\\pcap1.pcap', 'test_data\\mixed_files\\pcap2.pcap', 'test_data\\mixed_files\\txt1.txt', 'test_data\\pcap_files\\pcap1.pcap', 'test_data\\pcap_files\\pcap2.pcap', 'test_data\\txt_files\\txt1.txt']

def test_getFilesFromFileOrDirectory_file_csv1():
  assert teFileHandler.getFilesFromFileOrDirectory(file_csv1) == ['test_data\\csv_files\\csv1.csv']